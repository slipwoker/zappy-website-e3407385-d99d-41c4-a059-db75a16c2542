    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "אשכול פיס רמת גן משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            const response = await fetch('https://api.zappy5.com/api/email/contact-form', {
                ...
                body: JSON.stringify({
                    websiteId: 'e3407385-d99d-41c4-a059-db75a16c2542',
                    name: data.name || '',
                    email: data.email || '',
